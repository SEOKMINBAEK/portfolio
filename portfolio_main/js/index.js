...
let floor2_arrive = () => {
    ...
    let project_link_array = [
        'https://seokminbaek.github.io/2022portfolio/%EB%B0%B0%EB%8B%AC%EC%9D%98%EB%AF%BC%EC%A1%B1/html/baemin.html', //배달의민족 클론코딩
        'https://seokminbaek.github.io/2022portfolio/bookStreer_final_ver/bookStreet.html', // 경의선책거리 페이지
        'https://seokminbaek.github.io/2022portfolio/matrix_calculator/matrix.html', // 행렬계산기
        'https://seokminbaek.github.io/2022portfolio/base_converter_final_ver/base_converter.html', // 진수변환기
        'https://seokminbaek.github.io/2022portfolio/interest_calcurator_final/interest.html', // 대출이자 계산기
        'https://seokminbaek.github.io/2022portfolio/Elevator/elevator.html', // 엘리베이터 구현
    ...
    display_project.style.backgroundImage = `url('../img/project_${project_background_array[0]}.png')`;
    ...
    let show_project = () => { //프로젝트 출력하는 함수
        display_project.style.backgroundImage = `url('../img/project_${project_background_array[0]}.png')`; // 사진은 항상 배열[0]만 보여줌
